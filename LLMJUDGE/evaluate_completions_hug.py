...
from eval_utils import compute_results_hashing, compute_results_classifier_hug, compute_results_advbench
...
def main():
    ...
    cls = AutoModelForCausalLM.from_pretrained(args.cls_path, torch_dtype=torch.bfloat16, device_map="auto")
    ...
    for behavior_id, data in tqdm(completions.items()):
        ...
        if 'hash_check' in tags:
            ...
            current_results = compute_results_classifier_hug(behavior_dict, data, tokenizer, cls)
